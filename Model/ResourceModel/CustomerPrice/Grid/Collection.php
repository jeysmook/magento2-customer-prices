...
namespace Jeysmook\CustomerPrices\Model\ResourceModel\CustomerPrice\Grid;

use Jeysmook\CustomerPrices\Model\ResourceModel\CustomerPrice;
use Jeysmook\CustomerPrices\Model\ResourceModel\CustomerPrice\Collection as CustomerPriceCollection;
 ...
 */
class Collection extends CustomerPriceCollection implements SearchResultInterface
{
    /**
    ...
    public function __construct(
        ...
        string $eventPrefix = self::EVENT_PREFIX . '_grid',
        string $eventObject = self::EVENT_OBJECT . '_grid',
